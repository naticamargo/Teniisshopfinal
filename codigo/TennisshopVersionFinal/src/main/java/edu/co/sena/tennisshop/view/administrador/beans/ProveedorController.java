...
import edu.co.sena.tennisshop.controler.administrador.beans.ProveedorFacade;
...
public class ProveedorController implements Serializable {
    ...
    @EJB
    private edu.co.sena.tennisshop.controler.administrador.beans.ProveedorFacade ejbFacade;
    ...
    protected void initializeEmbeddableKey() {
        selected.setProveedorPK(new edu.co.sena.tennisshop.modelo.entities.ProveedorPK());
    }
    ...
    public Proveedor getProveedor(edu.co.sena.tennisshop.modelo.entities.ProveedorPK id) {
    ...
    public static class ProveedorControllerConverter implements Converter {
        ...
        edu.co.sena.tennisshop.modelo.entities.ProveedorPK getKey(String value) {
            edu.co.sena.tennisshop.modelo.entities.ProveedorPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new edu.co.sena.tennisshop.modelo.entities.ProveedorPK();
            key.setTipoDocumento(values[0]);
            key.setNumeroDocumento(values[1]);
            return key;
        }

        String getStringKey(edu.co.sena.tennisshop.modelo.entities.ProveedorPK value) {
