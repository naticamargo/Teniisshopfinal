...
import edu.co.sena.tennisshop.controler.administrador.beans.PedidoFacade;
...
public class PedidoController implements Serializable {
    ...
    @EJB
    private edu.co.sena.tennisshop.controler.administrador.beans.PedidoFacade ejbFacade;
