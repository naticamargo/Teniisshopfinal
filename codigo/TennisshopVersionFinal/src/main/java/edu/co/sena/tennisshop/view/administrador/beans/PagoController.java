...
import edu.co.sena.tennisshop.controler.administrador.beans.PagoFacade;
...
public class PagoController implements Serializable {
    ...
    @EJB
    private edu.co.sena.tennisshop.controler.administrador.beans.PagoFacade ejbFacade;
