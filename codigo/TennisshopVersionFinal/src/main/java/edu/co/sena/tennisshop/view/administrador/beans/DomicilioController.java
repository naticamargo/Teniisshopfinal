...
import edu.co.sena.tennisshop.controler.administrador.beans.DomicilioFacade;
...
public class DomicilioController implements Serializable {
    ...
    @EJB
    private edu.co.sena.tennisshop.controler.administrador.beans.DomicilioFacade ejbFacade;
    ...
    public Domicilio getDomicilio(java.lang.Integer id) {
