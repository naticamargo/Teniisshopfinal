...
import edu.co.sena.tennisshop.controler.administrador.beans.CuentaFacade;
...
public class CuentaController implements Serializable {
    ...
    @EJB
    private edu.co.sena.tennisshop.controler.administrador.beans.CuentaFacade ejbFacade;
    ...
    protected void initializeEmbeddableKey() {
        selected.setCuentaPK(new edu.co.sena.tennisshop.modelo.entities.CuentaPK());
    }
    ...
    public Cuenta getCuenta(edu.co.sena.tennisshop.modelo.entities.CuentaPK id) {
    ...
    public static class CuentaControllerConverter implements Converter {
        ...
        edu.co.sena.tennisshop.modelo.entities.CuentaPK getKey(String value) {
            edu.co.sena.tennisshop.modelo.entities.CuentaPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new edu.co.sena.tennisshop.modelo.entities.CuentaPK();
            key.setTipoDocumento(values[0]);
            key.setNumeroDocumento(values[1]);
            return key;
        }

        String getStringKey(edu.co.sena.tennisshop.modelo.entities.CuentaPK value) {
