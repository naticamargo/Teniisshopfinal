...
import edu.co.sena.tennisshop.controler.administrador.beans.ItemFacade;
...
public class ItemController implements Serializable {
    ...
    @EJB
    private edu.co.sena.tennisshop.controler.administrador.beans.ItemFacade ejbFacade;
    ...
    protected void initializeEmbeddableKey() {
        selected.setItemPK(new edu.co.sena.tennisshop.modelo.entities.ItemPK());
    }
    ...
    public Item getItem(edu.co.sena.tennisshop.modelo.entities.ItemPK id) {
    ...
    public static class ItemControllerConverter implements Converter {
        ...
        edu.co.sena.tennisshop.modelo.entities.ItemPK getKey(String value) {
            edu.co.sena.tennisshop.modelo.entities.ItemPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new edu.co.sena.tennisshop.modelo.entities.ItemPK();
            key.setProductoIdProducto(values[0]);
            key.setPedidoFacturaIdFactura(Integer.parseInt(values[1]));
            return key;
        }

        String getStringKey(edu.co.sena.tennisshop.modelo.entities.ItemPK value) {
