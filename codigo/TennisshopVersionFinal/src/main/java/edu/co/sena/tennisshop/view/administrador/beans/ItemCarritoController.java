...
import edu.co.sena.tennisshop.controler.administrador.beans.ItemCarritoFacade;
...
public class ItemCarritoController implements Serializable {
    ...
    @EJB
    private edu.co.sena.tennisshop.controler.administrador.beans.ItemCarritoFacade ejbFacade;
    ...
    protected void initializeEmbeddableKey() {
        selected.setItemCarritoPK(new edu.co.sena.tennisshop.modelo.entities.ItemCarritoPK());
    }
    ...
    public ItemCarrito getItemCarrito(edu.co.sena.tennisshop.modelo.entities.ItemCarritoPK id) {
    ...
    public static class ItemCarritoControllerConverter implements Converter {
        ...
        edu.co.sena.tennisshop.modelo.entities.ItemCarritoPK getKey(String value) {
            edu.co.sena.tennisshop.modelo.entities.ItemCarritoPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new edu.co.sena.tennisshop.modelo.entities.ItemCarritoPK();
            key.setProductoIdProducto(values[0]);
            key.setCARRITOCOMPRASidCARRITO(values[1]);
            return key;
        }

        String getStringKey(edu.co.sena.tennisshop.modelo.entities.ItemCarritoPK value) {
