...
import edu.co.sena.tennisshop.controler.administrador.beans.FacturaFacade;
...
public class FacturaController implements Serializable {
    ...
    @EJB
    private edu.co.sena.tennisshop.controler.administrador.beans.FacturaFacade ejbFacade;
