...
import edu.co.sena.tennisshop.controler.administrador.beans.InventarioFacade;
...
public class InventarioController implements Serializable {
    ...
    @EJB
    private edu.co.sena.tennisshop.controler.administrador.beans.InventarioFacade ejbFacade;
    ...
    protected void setEmbeddableKeys() {
        selected.getInventarioPK().setProveedorTipoDocumento(selected.getProveedor().getProveedorPK().getTipoDocumento());
    ...
    protected void initializeEmbeddableKey() {
        selected.setInventarioPK(new edu.co.sena.tennisshop.modelo.entities.InventarioPK());
    }
    ...
    public Inventario getInventario(edu.co.sena.tennisshop.modelo.entities.InventarioPK id) {
    ...
    public static class InventarioControllerConverter implements Converter {
        ...
        edu.co.sena.tennisshop.modelo.entities.InventarioPK getKey(String value) {
            edu.co.sena.tennisshop.modelo.entities.InventarioPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new edu.co.sena.tennisshop.modelo.entities.InventarioPK();
            key.setIdInventario(Integer.parseInt(values[0]));
            key.setProveedorTipoDocumento(values[1]);
            key.setProveedorNumeroDocumento(values[2]);
            key.setProductoIdProducto(values[3]);
            return key;
        }

        String getStringKey(edu.co.sena.tennisshop.modelo.entities.InventarioPK value) {
            StringBuilder sb = new StringBuilder();
            sb.append(value.getIdInventario());
            sb.append(SEPARATOR);
            sb.append(value.getProveedorTipoDocumento());
            sb.append(SEPARATOR);
